...
visualizer: solver/bfs_visualizer.cpp
	$(CXX) $(CXXFLAGS) -o solver/bfs_visualizer solver/bfs_visualizer.cpp

clean:
	rm -f solver/openmp_solver solver/seq_solver solver/seq_solver_cpp \
		solver/openmp_solver_cpp solver/openmp_solver_dfs_cpp solver/seq_solver_dfs_cpp solver/bfs_visualizer